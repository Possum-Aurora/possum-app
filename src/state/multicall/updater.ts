...
import { Contract as Multicall2 } from '@ethersproject/contracts'
import useActiveWeb3React from 'hooks/useActiveWeb3React'
import { useMulticall2Contract } from 'hooks/useContract'
import useDebounce from 'hooks/useDebounce'
import chunkArray from '../../utils/chunkArray'
import { retry, RetryableError } from './retry'
import { useBlockNumber } from '../block/hooks'
      ...
      cancellations: chunkedCalls.map((chunk, index) => {
        ...
        promise
          .then(({ results: returnData, blockNumber: fetchBlockNumber }) => {
            console.log('possum update results==', returnData)
            ...
            console.log('possum results==', results)
